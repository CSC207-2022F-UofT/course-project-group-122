...
public class Main {
    ...
    /**
     * The user pool of the application
     */
    private static UserPool userPool;

    /**
     * The study pool of the application
     */
    private static StudyPool studyPool;

    /**
     * The random group generator manager of the application
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Object obj : objs) {
            ...
            for (Object pool : c.getBox()) {
                switch (pool.getClass().getSimpleName()) {
                    case "UserPool":
                        userPool = (UserPool) pool;
                        break;
                    case "StudyPool":
                        studyPool = (StudyPool) pool;
                        break;
                    case "RandomGroupGeneratorManager":
                        randomGroupGeneratorManager = (RandomGroupGeneratorManager) pool;
                        break;
                    case "IDManager":
                        idManager = (IDManager) pool;
                        break;
                    default:
                        break;
                }

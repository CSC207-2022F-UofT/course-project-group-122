...
public class AddPotentialParticipantInteractor implements AddPotentialParticipantInputBoundary {
    ...
    public void addPotentialParticipant(int participantID, int studyId, int userId) {
        ...
        if (canBeAddedToStudy(participant, study)) {
            ...
            addPotentialParticipantPresenter.presentFailure(participantID, studyId, "Participant " + participantID +
                    " cannot be added to study " + studyId + " as a potential participant.");
        }
    }
    ...
    public void fetchParticipantInfo(int participantID, int studyId) {
        ...
        Study study = FetchId.getStudy(studyId);
        if (participant == null) {
            addPotentialParticipantPresenter.presentFailure(participantID, studyId, "Participant does not exist.");
        } else if (study == null) {
